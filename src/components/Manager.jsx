            ...
            <div className="p-2 md: p-0 md: mycontainer min-h-[84.6vh]">
                ...
                <div className='flex flex-col p-4 text-black gap-5 items-center'>
                    ...
                    <div className="flex flex-col md:flex-row w-full justify-between gap-3">
                        <input value={form.email} onChange={handleChange} placeholder='Enter Email' className='rounded-full border border-blue-500 w-full px-4 py-1' type="text" name='email' id='email' />
                    ...
                    <button onClick={savePassword} className='bg-blue-500 hover:bg-blue-700 flex justify-center item-center rounded-full px-2 py-2 w-fit border border-blue-900'>
                        <lord-icon
